...
(function(){
  ...
  var UI={
    en:{
      ...
      pm_title:"Pair with your partner 🌸",pm_intro:"Two devices, one rhythm. Create a space and share the code, or enter a code you were given. Your data stays between the two of you — nothing is stored on a server.",pm_yourname:"Your name",pm_create:"Create shared space",pm_copy:"Copy code",pm_or:"— or —",pm_partnercode:"Partner's code",pm_join:"Join their space",
      ...
      pc_justyou:"Just you — invite a partner",pc_paired:"Paired ({code}) · offline",pc_online:"{name} · online",tg_connected:"Connected 🌸",tg_waiting:"Waiting for partner…",tg_waitfor:"Waiting for {name} to open Fresh Life…",tg_synced:"Synced directly between the two of you — nothing is stored on a server.",p_rituals:"rituals",p_streak:"streak",p_forest:"forest",p_online:"online",p_offline:"offline",p_someone:"Someone",p_partner:"Partner",
