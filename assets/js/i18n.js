...
(function(){
  ...
  var UI={
    en:{
      ...
      habit_add_ph:"Add your own task…",habit_del:"Remove",q_routine:"Detail my day",q_send_routine:"Rebuild my whole day into a more detailed routine.",routine_applied:"✨ **Your day, rebuilt in more detail.**\nI've updated **My Tasks** under Today — take a look. Tap **reset** on that card anytime to go back to the default rhythm.",routine_revert:"✦ custom · reset",routine_fail:"I couldn't rebuild the routine cleanly this time — try again in a moment.",
